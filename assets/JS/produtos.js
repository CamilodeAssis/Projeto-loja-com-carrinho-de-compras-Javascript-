let prodJson = [
    {id:1, name:'Camiseta ', img:'images/camisa.png', price:20.19, sizes:['S', 'M', 'L'], description:'Descrição do produto em mais de uma linha muito legal bem interessante'},
    {id:2, name:'Camisa', img:'images/camiseta.png', price:18.00, sizes:['S', 'M', 'L'], description:'Descrição do produto em mais de uma linha muito legal bem interessante'},
    {id:3, name:'Moletom ', img:'images/casaco.png', price:17.45, sizes:['S', 'M', 'L'], description:'Descrição do produto em mais de uma linha muito legal bem interessante'},
